    ...
    def leaves_list(self):
        def leaves_generater(root):
            ...
            if root.left is None and root.right is None:
                ...
                yield from leaves_generater(root.left)
                yield from leaves_generater(root.right)
        return [data for data in leaves_generater(self.root)]
    ...
    def iterative_inorder(self):
        ...
        while (current):
            if (current.left is None):
                ...
                rightestLeftRoute = current.left
                while (rightestLeftRoute.right and
                        rightestLeftRoute.right != current):
                    rightestLeftRoute = rightestLeftRoute.right
                if (rightestLeftRoute.right is None):
                    rightestLeftRoute.right = current
                    current = current.left
                else:
                    rightestLeftRoute.right = None
                    yield current.data
                    current = current.right
